...
export const mockDirectorySubmissions: DirectorySubmission[] = [
  // Tier 1: Essential (DA 90+)
  {
    ...
    focusArea: 'Local',
    automation: 'auto',
    notes: 'Auto-sync NAP monthly; monitor for review responses.',
    aiDescription:
  ...
  },
  {
    ...
    focusArea: 'Local',
    automation: 'auto',
    notes: 'Push latest photos via automation workflow.',
    aiDescription:
  ...
  },
  {
    ...
    focusArea: 'Startup',
    automation: 'auto',
    notes: 'Auto-publish funding updates from Supabase feed.',
    aiDescription:
  ...
  },
  {
    ...
    focusArea: 'Product',
    automation: 'manual',
    notes: 'Schedule feature updates alongside launches.',
    aiDescription:
  ...
  },
  {
    ...
    focusArea: 'Local',
    automation: 'auto',
    notes: 'Synced alongside GMB push.',
    aiDescription:
